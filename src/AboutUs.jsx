  ...
  return (
    <div className="about-us-container">
      <h3 className="about-us-description">
        " Discover the Beauty of <span style={{ color: "#4caf50" }}>Green</span>{" "}
        "
      </h3>
      <p className="about-us-content">
        At Green Galores, we are passionate about bringing nature closer to you.
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener,{" "}
        <span style={{ color: "#ab47bc" }}>colorful</span> world.
      </p>
    </div>
  );
}
